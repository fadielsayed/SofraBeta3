package com.example.mtador12.sofrabeta3.AddOffer;
...
public class AddOfferActivity extends Base2Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_add_offer, contentFrameLayout);
