package com.example.mtador12.sofrabeta3.DetailsRequest;
...
public class DetailsRequestActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initToolBar("تفاصيل الطلب");
        FrameLayout contentFrameLayout = (FrameLayout) findViewById(R.id.content_frame);
        getLayoutInflater().inflate(R.layout.activity_request_detail, contentFrameLayout);
